  ...
  return (
    <div className="w-full bg-white flex flex-col justify-center items-center px-4 py-10 md:px-10 md:py-10 rounded-lg">
      <form
        ...
        className="fieldset w-full *:w-full *:rounded-lg"
      >
        <h1 className="text-forest-matte text-center font-bold text-2xl md:text-4xl">
        ...
        <input
          ...
          ref={emailRef}
          name="email"
          className="input border-charcoal-green text-charcoal-green focus:border-eucalyptus"
          placeholder="Email"
        />
        <label className="label text-charcoal-green font-semibold">
          Password
        </label>
        ...
        <div>
          <a
            className="link link-hover text-eucalyptus"
            onClick={handleForgetPass}
          >
            Forgot password?
          </a>
        </div>
        <button className="btn btn-neutral bg-eucalyptus hover:bg-charcoal-green text-white border-0 mt-4">
          Login
        </button>
      </form>
      ...
      <button
        ...
        className="w-full btn btn-neutral hover:bg-eucalyptus hover:text-white border-charcoal-green bg-white text-charcoal-green"
      >
        Continue with Google <FaGoogle></FaGoogle>
      </button>
      {error && <p className="text-red-700 text-sm mt-4">{error}</p>}
      <p className="text-charcoal-green mt-4">
        Dont have an account?
        <Link to="/auth/signUp" className="text-eucalyptus">
          Sign Up.
        </Link>
      </p>
    </div>
